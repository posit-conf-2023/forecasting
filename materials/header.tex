...
{\placefig{-0.01}{-0.01}{width=1.01\paperwidth,height=1.01\paperheight}{chicago.jpg}
\begin{textblock}{8.5}(.5,0.2)
  ...
  \end{textblock}
\placefig{8.5}{.2}{width=2.4cm}{tsibble.png}
\placefig{10.9}{.2}{width=2.4cm}{feasts.png}
\placefig{13.3}{.2}{width=2.4cm}{fable.png}
\begin{textblock}{7.5}(.5,8.5)\fontsize{9}{9}\sf
\textcolor{Orange}{\href{http://bit.ly/tidyts2023}{bit.ly/tidyts2023}}
\end{textblock}
\begin{textblock}{10}(13.2,8.8)\fontsize{5}{5}\sf
\textcolor[rgb]{0.8,0.8,0.8}{Photo by \href{https://unsplash.com/@maxwbender?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText}{Max Bender} on \href{https://unsplash.com/wallpapers/travel/chicago?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText}{Unsplash}}
\end{textblock}
}
